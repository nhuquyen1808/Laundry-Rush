...
namespace DevDuck
{
    public class LeftButtonGame1 : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        bool isPressed;
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            isPressed = true;
            LogicGame1.instance.clawMachineHandle.AnimationState.SetAnimation(0, "left", false);
        }
